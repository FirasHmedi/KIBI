...
export const placeAnimalOnBoard = (roomId: string, playerId: string, slotNumber: string, animalId: string) => {
  // addInfoToLog (unit action)
  // addAnimalToBoard (unit action)
  // removeCardFromPlayerDeck (unit action)
};
export const placeKingOnBoard = (roomId: string, playerId: string, kingId: string, sacrificedAnimalId: string) => {
  // addInfoToLog (unit action)
